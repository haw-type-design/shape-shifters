document.addEventListener("DOMContentLoaded", () => {
    scrollTo(380, 1500);
    imageCaller();
    let hashlinks = document.querySelectorAll("a");
    ...
    hashlinks.forEach(element => element.addEventListener("click", function() {
        if (this.hash !== "") {
    ...
    /* Solution from here: https://stackblitz.com/edit/multi-touch-trackpad-gesture?file=index.js */
    var node;
    var rotation = 0;
    ...
    var textContainer = document.getElementById("Specimen");
    ...
    slider.addEventListener("input", function() {
        ...
        textContainer.style.lineHeight = fontSize;

        document.getElementById("value-size").innerText = fontSize;
    });




    document.getElementById("font-switch").addEventListener("click", function() {
        document.getElementById("Specimen").classList.toggle("other");

        document.getElementById("slider-2").classList.toggle("invisible");
    });
    ...
    document.getElementById("slider-wght").addEventListener("input", function () {
        ...
        document.getElementById("Specimen").style.setProperty("font-variation-settings","'TIME' "+ axisValue, "");
