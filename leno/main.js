document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("slider-HRZT").addEventListener("input", function () {

        let axisValue = "'HRZT'" + document.getElementById("slider-HRZT").value + ", 'VRCL'" + document.getElementById("slider-VRCL").value;

        document.getElementById("testarea").style.setProperty('font-variation-settings',axisValue,"");

        document.getElementById("value-HRZT").innerText = document.getElementById("slider-HRZT").value;

    });

    document.getElementById("slider-VRCL").addEventListener("input", function () {

        let axisValue = "'HRZT'" + document.getElementById("slider-HRZT").value + ", 'VRCL'" + document.getElementById("slider-VRCL").value;

        document.getElementById("testarea").style.setProperty('font-variation-settings',axisValue,"");

        document.getElementById("value-VRCL").innerText = document.getElementById("slider-VRCL").value;

    });



    document.getElementById("bild1").addEventListener("click",
                                                      function () {
        document.getElementById("bild1-img").classList.toggle("display");
        document.getElementById("bild1-img").classList.toggle("animation-left");
    });


    document.getElementById("bild2").addEventListener("click",
                                                      function () {
        document.getElementById("bild2-img").classList.toggle("display");

        document.getElementById("bild2-img").classList.toggle("animation-right");

    });


    document.getElementById("bild3").addEventListener("click",
                                                      function () {
        document.getElementById("bild3-img").classList.toggle("display");

        document.getElementById("bild3-img").classList.toggle("animation-right");


    });


    document.getElementById("bild4").addEventListener("click",
                                                      function () {
        document.getElementById("bild4-img").classList.toggle("display");

        document.getElementById("bild4-img").classList.toggle("animation-left");
    });


    document.getElementById("bild5").addEventListener("click",
                                                      function () {
        document.getElementById("bild5-img").classList.toggle("display");

        document.getElementById("bild5-img").classList.toggle("animation-right");
    });


    document.getElementById("bild6").addEventListener("click",
                                                      function () {
        document.getElementById("bild6-img").classList.toggle("display");

        document.getElementById("bild6-img").classList.toggle("animation-left");

    });



    document.getElementById("bild7").addEventListener("click",
                                                      function () {
        document.getElementById("bild7-img").classList.toggle("display");

        document.getElementById("bild7-img").classList.toggle("animation-right");
    });
